...
<html>
    <head>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
        <%
            ArrayList<Job> jobList = (ArrayList<Job>) session.getAttribute("parttimejob");
                    ...
                    <div class="container col-lg-10 offset-lg-1 py-2">
                        <div class="row bg-primary bg-opacity-75 rounded-3" style="background-color: #f39f86; background-image: linear-gradient(315deg, #f39f86 0%, #f9d976 74%)">
                            <div class="my-2 d-flex justify-content-between text-light">
                                <span><i class="far fa-list font text-dark fw-bold"> Part-time JOB</i> </span>
                            </div>
                        </div>
                        <div class="row ">
                        <c:forEach var="j" items="${parttimejob}">
                            <div class="card mb-1 ">
                                    <div class="row g-0">
                                        <div class="col-md-3">
