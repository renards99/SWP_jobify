...
public class PaymentServices {
	...
	public String authorizePayment(OrderDetail orderDetail, String fullname,String email)			
			throws PayPalRESTException {		

		Payer payer = getPayerInformation(fullname,email);
	...
	private Payer getPayerInformation(String fullname, String email) {
		Payer payer = new Payer();
		payer.setPaymentMethod("paypal");
		
		PayerInfo payerInfo = new PayerInfo();
		payerInfo.setFirstName(fullname)
				 .setLastName("")
				 .setEmail(email);
