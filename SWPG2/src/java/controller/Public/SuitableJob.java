 ...
 * @author PC
 */
public class SuitableJob extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SuitableJob</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SuitableJob at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        User user = (User) session.getAttribute("acc");
         int pageSize2 = 6;
            ...
            request.setAttribute("controller", "suitable_job");
            session.setAttribute("suitablejob", suitablejob);
         request.getRequestDispatcher("Public/SuitableJob.jsp").forward(request, response);
    }
