                    ...
                    <div class="container col-lg-10 offset-lg-1 py-2">
                        <div class="row bg-primary bg-opacity-75 rounded-3" style="background-color: #f39f86; background-image: linear-gradient(315deg, #f39f86 0%, #f9d976 74%)">
                            <div class="my-2 d-flex justify-content-between text-light">
                                <span><i class="far fa-thumbs-up font text-dark fw-bold"> List Banner</i> </span>
                            </div>
                        </div>
                        <div class="row ">
                            <c:forEach var="j" items="${listbanner}">
                                <input type="text" hidden="" value="${j.bannerID}" id="jobid"> 
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-5">
                                            <div class="card-body  text-truncate">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <small class="text-muted">Username: ${j.username}</small>
                                                    </div>
                                                    <div class="col-md-6">
