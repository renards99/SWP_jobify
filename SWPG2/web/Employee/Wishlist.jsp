                    ...
                    <div class="container col-lg-10 offset-lg-1 py-2">
                        <div class="row bg-primary bg-opacity-75 rounded-3" style="background-color: #f39f86; background-image: linear-gradient(315deg, #f39f86 0%, #f9d976 74%)">
                            <div class="my-2 d-flex justify-content-between text-light">
                                <span><i class="far fa-thumbs-up font text-dark fw-bold"> Wishlist</i> </span>
                            </div>
                        </div>
                        <div class="row ">
                        <c:forEach var="j" items="${listwishlist}">
                            <div class="card mb-1 ">
                                    <div class="row g-0">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9">
                                            <div class="card-body  text-truncate">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <small class="text-muted">Location: ${j.getLocation()}</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
